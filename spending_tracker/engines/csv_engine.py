...
class CSVEngine:
    ...
    def venmo(self, file_path, file_name, cleaned_csv_path):
        source = "venmo"
        assert (
            source in file_name
    ...
    def amex(self, file_path, file_name, cleaned_csv_path):
        source = "amex"
        assert (
            source in file_name
        ), f"Error: source '{source}' is not in file name '{file_name}'"
    ...
    def citi(self, file_path, file_name, cleaned_csv_path):
        source = "citi"
        assert (
            source in file_name
        ), f"Error: source '{source}' is not in file name '{file_name}'"
    ...
    def amazon_refunds(self, file_path, file_name, cleaned_csv_path):
    ...
    def amazon_items(self, file_path, file_name, cleaned_csv_path):
        source = "amazon_items"
        assert (
            source in file_name
        ), f"Error: source '{source}' is not in file name '{file_name}'"
    ...
    def chase_freedom(self, file_path, file_name, cleaned_csv_path):
    ...
    def chase_debit(self, file_path, file_name, cleaned_csv_path):
        source = "chase_debit"
        assert (
            source in file_name
        ), f"Error: source '{source}' is not in file name '{file_name}'"
